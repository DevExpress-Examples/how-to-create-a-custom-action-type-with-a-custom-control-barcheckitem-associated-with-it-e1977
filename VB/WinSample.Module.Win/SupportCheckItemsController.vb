...
Namespace WinSample.Module.Win
	Partial Public Class SupportCheckItemsController
		...
		End Sub
		Private Sub DefaultBarActionItemsFactory_CustomizeActionControl(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.Win.Templates.ActionContainers.CustomizeActionControlEventArgs)
